...
const PreferenciasAlertas = () => {
  ...
  const toggleEstadoPreferencia = async (idPreferencia, estadoActual) => {
    ...
    try {
      ...
      toast({
        title: `Alerta ${!estadoActual ? 'activada' : 'desactivada'} con Exito`,
        status: 'success',
        duration: 3000,
        render: () => (
          <Box 
            ...
            fontSize="lg" 
          >
            Alerta {estadoActual ? 'desactivada' : 'activada'}
          </Box>
      ),
      });
    } catch (error) {
      ...
      toast({
        title: 'Error al cambiar el estado de la alerta',
        status: 'error',
        duration: 3000,
        render: () => (
          <Box 
              ...
              fontSize="lg"
          >
             Error al cambiar el estado de la alerta
          </Box>
      ),
      });
    }
  ...
  return (
    <Box bg={colorMode === 'light' ? 'gray.100' : 'gray.900'} color={colorMode === 'light' ? 'black' : 'white'} borderRadius="md" boxShadow="md" width="100%" p={4}>
      <Heading as="h1" mb={7} textAlign="center">Personalizar Alertas</Heading>
                  ...
                  >
                    ...
                    <Td textAlign="center">
                      <IconButton
                        ...
                        title={pref.estado ? "Desactivar Alerta" : "Activar Alerta"}
                        onClick={() => toggleEstadoPreferencia(pref.id, pref.estado)}
                        aria-label={pref.estado ? "Desactivar Alerta" : "Activar Alerta"}
                        background={buttonDefaultColor}
