...
const Title = styled.h1`
  font-size: 30px; /* Aumento del tamaño del título */
  color: rgb(255, 255, 255); /* Color del título */
  margin-bottom: 8px; /* Espacio debajo del título */
  font-weight: bold; /* Hacer el título más grueso */
  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5); /* Agregar sombra para profundidad */
`;

const Subtitle = styled.h2`
  font-size: 24px; /* Aumento del tamaño del subtítulo */
  color: rgb(220, 220, 220); /* Color del subtítulo */
  margin-bottom: 24px; /* Espacio debajo del subtítulo */
  font-style: italic; /* Hacer el subtítulo en cursiva */
  text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.5); /* Agregar sombra sutil para profundidad */
`;
